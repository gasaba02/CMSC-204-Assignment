...
public class DonationManagerSTUDENTTest {
	...
	public void testManagerLoadcontainer()   {
		...
		try {
			manager.managerLoadContainer(new DonationPackage("Pencils",12));
			manager.managerLoadContainer(new DonationPackage("Binders",12));
			manager.managerLoadContainer(new DonationPackage("NoteBooks",11));
			manager.managerLoadContainer(new DonationPackage("Couch",20));
			manager.managerLoadContainer(new DonationPackage("Tablets",14));
	...
	public void testManagerQueueVolunteer() {
		try {
			manager.managerQueueVolunteer(new  Volunteer("Jerry"));
			manager.managerQueueVolunteer(new  Volunteer("James"));
			manager.managerQueueVolunteer(new  Volunteer("Nick"));
			manager.managerQueueVolunteer(new  Volunteer("James"));
			manager.managerQueueVolunteer(new  Volunteer("Mike"));
			manager.managerQueueVolunteer(new  Volunteer("Jeremy"));
	...
	public void testManagerQueueRecipient() {
		try {
			manager.managerQueueRecipient(new  Recipient("Jack"));
			manager.managerQueueRecipient(new  Recipient("Adian"));
	...
	public void testDonatePackage() {
		 Volunteer v1;
		    ...
		    v1 = new Volunteer("Jane"); 
			r1 =  new Recipient("PG College");
			
			d1 =  new DonationPackage("Pencil",10);
			d2 =  new DonationPackage("Binders",20);
